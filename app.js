const state={items:window.BIKE_DATA||[],filtered:[],selected:null,selectedIcn:null,system:'All',kind:'All',tab:'content',query:'',role:'Author',library:'dashboard'};
